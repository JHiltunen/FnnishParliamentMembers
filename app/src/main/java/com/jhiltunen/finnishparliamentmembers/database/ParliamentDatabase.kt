...
/**
 * A database that stores ParliamentMember and MemberLikes information.
 * Global method to get access to the database.
 */
...
abstract class ParliamentDatabase : RoomDatabase() {
    ...
    /**
     * Define a companion object, this allows us to add functions on the ParliamentDatabase class.
     *
     * For example, clients can call `ParliamentDatabase.getInstance(context)` to instantiate
     * a new ParliamentDatabase.
     */
    companion object {
        /**
